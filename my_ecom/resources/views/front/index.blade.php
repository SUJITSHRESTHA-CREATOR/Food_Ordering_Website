          ...
          <div class="aa-support-area">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="aa-support-single">
                ...
                <h4>FREE ORDERING</h4>
                <P>Ordering is free of cost. No extra cash required.</P>
              </div>
            </div>
            <!-- single support -->
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="aa-support-single">
                ...
                <h4>FAST DELIVERY</h4>
                <P>We deliver your meal as fast as possible.</P>
              </div>
            </div>
            <!-- single support -->
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="aa-support-single">
                ...
                <h4>SUPPORT 24/7</h4>
                <P>Customers can call on our number for any queries. We are ready all the time..</P>
              </div>
            </div>
          </div>
        </div>
