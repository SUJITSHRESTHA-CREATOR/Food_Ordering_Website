            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                ...
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>01-5006358</p>
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="{{url('/')}}">
                  ...
                  <p>Food<strong>Order</strong> <span>Your Daily Appetite</span></p>
                </a>
                <!-- img based logo -->
              ...
              <div class="aa-cartbox">
                <a class="aa-cart-link" href="#" id="cartBox">
                  ...
                  <span class="aa-cart-title">FOOD CART</span>
              ...
              <div class="aa-search-box">
                <form action="">
                  <input type="text" id="search_str" placeholder="Search here ex. 'Pizza' ">
                ...
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    ...
                    <address>
                      <p> Balkumari, Nepal</p>
                      <p><span class="fa fa-phone"></span>01-5006358</p>
                      <p><span class="fa fa-envelope"></span>FoodOrder@gmail.com</p>
                    </address>
