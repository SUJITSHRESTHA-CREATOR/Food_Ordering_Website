                  ...
                  <div class="card-body">
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              <label for="category_id" class="control-label mb-1"> Restaurant(B)</label>
                           ...
                           <div class="col-md-4">
                              <label for="model" class="control-label mb-1"> Specific Name Or Write same name[Required]</label>
                     ...
                     <div class="form-group">
                      ...
                      <!--<div class="form-group">
                        <label for="uses" class="control-label mb-1"> Health Benefits if any</label>
                        <textarea id="uses" name="uses" type="text" class="form-control" aria-required="true" aria-invalid="false" >{{$uses}}</textarea>
                     </div>-->
                     <div class="form-group">
                        <label for="warranty" class="control-label mb-1"> Ingredients</label>
               ...
               <div class="card" id="product_attr_{{$loop_count_num++}}">
                  <div class="card-body">
                     <div class="form-group">
                        <div class="row">
                           <div class="col-md-2">
                              <label for="sku" class="control-label mb-1"> ID</label>
                           ...
                           <div class="col-md-3">
                              <label for="color_id" class="control-label mb-1"> Ingredients Option</label>
