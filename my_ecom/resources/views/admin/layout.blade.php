...
<div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="{{url('admin/dashboard')}}">
                            <img src="{{asset('admin_assets/images/icon/S_Admin.jpg')}}" alt="CoolAdmin" width="100px" height="100px" />
                        </a>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="{{url('admin/dashboard')}}">
                    <img src="{{asset('admin_assets/images/icon/S_Admin.jpg')}}" width="100px" height="100px" />
                </a>
            </div>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="@yield('product_review_select')">
                            ...
                            <i class="fas fa-star"></i>Food Review</a>
                        </li>
                        <li class="@yield('category_select')">
                            <a href="{{url('admin/category')}}">
                                <i class="fas fa-list"></i>Category</a>
                        ...
                        <li class="@yield('brand_select')">
                            <a href="{{url('admin/brand')}}">
                            <i class="fa fa-bold"></i>Restaurant</a>
                        </li>
                        ...
                        <li class="@yield('product_select')">
                            <a href="{{url('admin/product')}}">
                            <i class="fa fa-product-hunt"></i>Food</a>
                        </li>
                        ...
                        <li class="@yield('home_banner_select')">
                            ...
                            <i class="fas fa-images"></i>Home Banner</a>
                                                ...
                                                <li class="@yield('new_section_select')">
                                                    <a href="{{url('admin/new_section')}}">
                                                    <i class="fas fa-images"></i>new section</a>
                                                </li>
